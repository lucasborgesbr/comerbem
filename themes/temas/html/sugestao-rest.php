...
$sql = "SELECT * FROM tb_sugestaorest";
                                ...
                                <div class="d-flex align-items-end row">
                                    <div class="col-sm-7">
                                        <div class="card-body">
                                            <h5 class="card-title text-primary">
                                                <?= $_SESSION['nome_admin'] ?></h5>
                                            <p class="mb-4">
                                                Estes são os <span class="fw-bold">restaurantes </span> sugeridos pelos
                                    ...
                                    <div class="col-sm-5 text-center text-sm-left">
                                        <div class="card-body pb-0 px-0 px-md-4">
                                            <img
                                                    src="../assets/img/illustrations/sugestao.png" height="140"
                                                    alt="View Badge User"
                            ...
                            <table class="table">
                                ...
                                while ($row_restaurantes = $resultado->fetch_assoc()) {
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="https://instagram.com/<?= $row_restaurantes['perfil'] ?>"
                                               target="_blank">@<?= $row_restaurantes['perfil'] ?></a></td>
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu">
                                                    <a class="dropdown-item"
                                                       href="functions/delete_sugestao.php?id=<?=$row_restaurantes['id_sugestaoRest']?>>"><i
